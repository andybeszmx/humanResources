...
import { useUserStore } from '@/store/modules/user' // 引入pinia的user仓库
...
const homeData = ref({})
const list = ref([])
const socialChart = ref(null) // 图表ref
const providentChart = ref(null)
const social = ref(null) // 社保图表实例
const provident = ref(null) // 公积金图表实例
...
onMounted(() => {
  ...
  provident.value = echarts.init(providentChart.value)
      ...
      <div class="left">
        <div class="panel">
          ...
          <div class="todo-list">
            <div class="todo-item">
              <span>组织总人数</span>
              <NumberScroll :end-val="homeData.employeeTotal" :duration="1000" ></NumberScroll>
            </div>
            <div class="todo-item">
              <span>正式员工</span>
              <NumberScroll :end-val="homeData.regularEmployeeTotal" :duration="1000" ></NumberScroll>
            </div>
            <div class="todo-item">
              <span>合同待签署</span>
              <NumberScroll :end-val="homeData.contractSignTotal" :duration="1000" />
            </div>
            <div class="todo-item">
              <span>待入职</span>
              <NumberScroll :end-val="homeData.toBeEmployed" :duration="1000" />
            </div>
            <div class="todo-item">
              <span>本月待转正</span>
              <NumberScroll :end-val="homeData.toBeConfirmed" :duration="1000" />
            </div>
            <div class="todo-item">
              <span>本月待离职</span>
              <NumberScroll :end-val="homeData.toBeDismissed" :duration="1000" />
            </div>
            <div class="todo-item">
              <span>接口总访问</span>
              <NumberScroll :end-val="homeData.interfaceAccessTotal" :duration="1000" />
            </div>
          </div>
        </div>
        <!-- 快捷入口 -->
