      ...
      <div class="right">
        ...
        <el-table :data="list" border style="width: 100%">
          ...
          <el-table-column label="操作" width="280" align="center">
            <template #default="{ row }">
              <el-button size="small" type="text" @click="router.push(`/employee/detail/${row.id}`)">查看</el-button>
              <el-button size="small" type="text" @click="roleChoose(row.id)">角色</el-button>
              <el-popconfirm
                title="确定删除该员工吗？"
